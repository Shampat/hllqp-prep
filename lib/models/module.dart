...
const List<ModuleInfo> allModules = [
  ...
  ModuleInfo(id: 'segregated_funds', name: 'Segregated Funds', assetFile: 'assets/questions/segregated_funds_questions.json', icon: '📊', color: '#9C27B0', description: 'Seg funds, guarantees, resets'),
